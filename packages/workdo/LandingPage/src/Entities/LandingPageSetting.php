...
class LandingPageSetting extends Model
{
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            'highlight_feature_description' => 'With BookingGo, you can conveniently manage all your business functions from a single location.',
    ...
    {
        $fontArray = json_decode(file_get_contents(base_path('packages/workdo/LandingPage/src/Resources/assets/assets/google_fonts.json')), true);
        $family = [];
