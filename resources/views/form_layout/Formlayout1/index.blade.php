                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="form-steps-left">
                            <div class="section-title">
                                <h2>{{ __('Book') }} <b>{{ __('Appointment') }}</b></h2>
                            </div>
                            <div class="steps">
                                <ul>
                                    ...
                                    {{-- <span class="onlineAppointmentStep" id="onlineAppointmentStep">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="serviceSelect" name="service" disabled required>
                                                        <option value="" disabled selected>
                                                            {{ __('Select category first') }}
                                                        </option>
                                                    </select>
                                    ...
                                    <div class="tabs-wrapper">
                                        ...
                                        <ul class="tabs">
                                            @if(empty($bookingModes) || in_array('1', $bookingModes))
                                                <li data-tab="new-user" class="{{ in_array('1', $bookingModes) ? 'active' : '' }} tab-link">
