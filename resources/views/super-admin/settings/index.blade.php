  ...
  <script>
      @if ($successMessage)
      console.log('SUCCESS_MESSAGE in settings partial:', '{{ addslashes($successMessage) }}');
      toastrs('Success', '{{ $successMessage }}', 'success');
      @endif
      @if ($errorMessage)
      console.log('ERROR_MESSAGE in settings partial:', '{{ addslashes($errorMessage) }}');
  ...
  <div id="site-settings" class="">
      {{ Form::open(['route' => ['super.admin.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'setting-form', 'novalidate' => true]) }}
      @method('post')
      <div class="card">
                              ...
                              <div class="d-flex flex-column justify-content-between align-items-center h-100">
                                  <div class="logo-content img-fluid logo-set-bg text-center py-2">
                                      @php
                                          ...
                                          // DEBUG LOGGING
                                          \Log::info('[VIEW] Logo Light Debug:');
                                          \Log::info('[VIEW]   isset check: ' . (isset($settings['logo_light']) ? 'TRUE' : 'FALSE'));
                                          if (isset($settings['logo_light'])) {
                                              \Log::info('[VIEW]   $settings[logo_light] = ' . $settings['logo_light']);
                                              \Log::info('[VIEW]   check_file() returns: ' . (check_file($settings['logo_light']) ? 'TRUE' : 'FALSE'));
                                              \Log::info('[VIEW]   file_exists(base_path()) = ' . (file_exists(base_path($settings['logo_light'])) ? 'TRUE' : 'FALSE'));
                                              \Log::info('[VIEW]   base_path() = ' . base_path($settings['logo_light']));
                                          }
                                          \Log::info('[VIEW]   Final $logo_light = ' . $logo_light);
                                          \Log::info('[VIEW]   get_file($logo_light) = ' . get_file($logo_light));
                                          \Log::info('[VIEW]   Full img src = ' . get_file($logo_light) . '?' . time());
                                      @endphp
                  ...
                  <div class="row row-gap">
                      ...
                      <div class="col-xxl-3 col-md-4 col-sm-6 col-12">
                          <div class="card h-100 mb-0">
                              <div class="card-header p-2">
                                  <h6 class="">
                                      <i class="ti ti-align-right me-2 h5"></i>
                                      {{ __('RTL Layout') }}
                                  </h6>
                              </div>
                              <div class="card-body p-2">
                          ...
                          <div class="card h-100 mb-0">
                                  ...
                                  <h6 class="">
                                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                          ...
                                          <g clip-path="url(#clip0_803_74)">
                                              <path
                                                  d="M14.2814 0H1.71863C0.770996 0 0 0.770996 0 1.71863V14.2814C0 15.229 0.770996 16 1.71863 16H14.2814C15.229 16 16 15.229 16 14.2814V1.71863C16 0.770996 15.229 0 14.2814 0ZM1.71863 0.9375H14.2814C14.712 0.9375 15.0625 1.28796 15.0625 1.71863V3.78125H0.9375V1.71863C0.9375 1.28796 1.28796 0.9375 1.71863 0.9375ZM14.2814 15.0625H1.71863C1.28796 15.0625 0.9375 14.712 0.9375 14.2814V4.71875H15.0625V14.2814C15.0625 14.712 14.712 15.0625 14.2814 15.0625Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M14.0938 2.375C14.0938 2.63391 13.8839 2.84375 13.625 2.84375C13.3661 2.84375 13.1562 2.63391 13.1562 2.375C13.1562 2.11609 13.3661 1.90625 13.625 1.90625C13.8839 1.90625 14.0938 2.11609 14.0938 2.375Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M12.2188 2.375C12.2188 2.63391 12.0089 2.84375 11.75 2.84375C11.4911 2.84375 11.2812 2.63391 11.2812 2.375C11.2812 2.11609 11.4911 1.90625 11.75 1.90625C12.0089 1.90625 12.2188 2.11609 12.2188 2.375Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M10.3438 2.375C10.3438 2.63391 10.1339 2.84375 9.875 2.84375C9.61609 2.84375 9.40625 2.63391 9.40625 2.375C9.40625 2.11609 9.61609 1.90625 9.875 1.90625C10.1339 1.90625 10.3438 2.11609 10.3438 2.375Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M5.1875 7.53125H10.8125C11.0714 7.53125 11.2812 7.32141 11.2812 7.0625C11.2812 6.80359 11.0714 6.59375 10.8125 6.59375H5.1875C4.92859 6.59375 4.71875 6.80359 4.71875 7.0625C4.71875 7.32141 4.92859 7.53125 5.1875 7.53125Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M12.6875 8.46875H3.3125C3.05359 8.46875 2.84375 8.67859 2.84375 8.9375C2.84375 9.19641 3.05359 9.40625 3.3125 9.40625H12.6875C12.9464 9.40625 13.1562 9.19641 13.1562 8.9375C13.1562 8.67859 12.9464 8.46875 12.6875 8.46875Z"
                                                  fill="#060606"></path>
                                              <path
                                                  d="M9.40625 10.3438H6.59375C5.81836 10.3438 5.1875 10.9746 5.1875 11.75C5.1875 12.5254 5.81836 13.1562 6.59375 13.1562H9.40625C10.1816 13.1562 10.8125 12.5254 10.8125 11.75C10.8125 10.9746 10.1816 10.3438 9.40625 10.3438ZM9.40625 12.2188H6.59375C6.33533 12.2188 6.125 12.0084 6.125 11.75C6.125 11.4916 6.33533 11.2812 6.59375 11.2812H9.40625C9.66467 11.2812 9.875 11.4916 9.875 11.75C9.875 12.0084 9.66467 12.2188 9.40625 12.2188Z"
                                                  fill="#060606"></path>
                                          </g>
                                          <defs>
                              ...
                              <div class="card-body p-2">
                                  <div class="form-check form-switch d-flex gap-2 flex-column p-0">
                                      ...
                                      <input type="checkbox" class="form-check-input ms-0 mb-3" id="landing_page"
                                          name="landing_page"
                          ...
                          <div class="card h-100 mb-0">
                              ...
                              <div class="card-body p-2">
                                  <div class="form-check form-switch d-flex gap-2 flex-column p-0">
                                      ...
                                      <input type="checkbox" class="form-check-input ms-0 mb-3" id="signup"
                                          name="signup"
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6 col-12">
                              <div class="form-group col switch-width">
                                  ...
                                  <select class="form-control" data-trigger name="defult_language"
                                      id="defult_language" placeholder="This is a search placeholder">
                  ...
                  <div class="card-body p-3 pb-0">
                      <div class="row">
                          <div class="col-xxl-4 col-sm-6">
                              <div class="form-group col switch-width">
                                  {{ Form::label('currency_format', __('Decimal Format'), ['class' => ' col-form-label pt-0']) }}
                          ...
                          <div class="col-xxl-4 col-sm-6">
                              <div class="form-group col switch-width">
                                  {{ Form::label('defult_currancy', __('Default Currancy'), ['class' => ' col-form-label pt-0']) }}
                          ...
                          <div class="col-xxl-4 col-sm-6">
                              <div class="form-group col switch-width">
                                  <label for="float_number"
                                      class="col-form-label pt-0">{{ __('Float Number') }}</label>
                          ...
                          <div class="col-xxl-4 col-sm-6">
                              <div class="form-group col switch-width">
                                  <label for="decimal_separator"
                                      class="col-form-label pt-0">{{ __('Decimal Separator') }}</label>
                          ...
                          <div class="col-xxl-4 col-sm-6">
                              <div class="form-group col switch-width">
                                  <label for="thousand_separator"
                                      class="col-form-label pt-0">{{ __('Thousands Separator') }}</label>
                                      ...
                                      <div class="form-group mb-0 switch-width">
                                          <div class="form-check mb-2">
                                              <input class="form-check-input currency_note pointer" type="radio"
                                                  ...
                                                  @if (!isset($settings['site_currency_symbol_name']) || $settings['site_currency_symbol_name'] == 'symbol') checked @endif
                                                  id="currencySymbol">
      ...
      <div class="card-body p-3 pb-0">
          <div class="row ">
              <div class="col-sm-6 col-12 mb-3">
                  <div class="card h-100 mb-0">
                      <div class="card-body p-2">
                          <div class="form-check form-switch custom-switch-v1 mb-2" id="cookie_log">
                              ...
                              <small
                                  class="d-block text-danger">{{ __('After enabling logging, user cookie data will be stored in CSV file.') }}</small>
                          </div>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-6 col-12">
                  <div class="form-group">
                      {{ Form::label('cookie_title', __('Cookie Title'), ['class' => 'col-form-label pt-0']) }}
              ...
              <div class="col-sm-6 col-12">
                  ...
                  <div class="form-group ">
                      {{ Form::label('strictly_cookie_title', __(' Strictly Cookie Title'), ['class' => 'col-form-label pt-0']) }}
              ...
              <div class="col-sm-6 col-12">
                  <div class="form-group">
                      {{ Form::label('more_information_description', __('Contact Us Description'), ['class' => 'col-form-label pt-0']) }}
              ...
              <div class="col-sm-6 col-12">
                  <div class="form-group ">
                      {{ Form::label('contactus_url', __('Contact Us URL'), ['class' => 'col-form-label pt-0']) }}
      ...
      <div class="card-body p-3 pb-0">
          ...
          <div
              ...
              <div class="form-group col-12 switch-width">
                  {{ Form::label('local_storage_validation', __('Only Upload Files'), ['class' => ' col-form-label pt-0']) }}
          ...
          <div
              ...
              <h4 class="small-title mb-3 mt-3">{{ __('AWS S3 Settings') }}</h4>
              ...
              <div class="form-group col-12 switch-width">
                  {{ Form::label('s3_storage_validation', __('Only Upload Files'), ['class' => ' col-form-label pt-0']) }}
          ...
          <div
              ...
              <div class="col-12">
                  <h4 class="small-title mb-3 mt-3">{{ __('Wasabi Settings') }}</h4>
                  <div class=" row ">
                      ...
                      <div class="form-group col-12 switch-width">
                          {{ Form::label('wasabi_storage_validation', __('Only Upload Files'), ['class' => ' col-form-label pt-0']) }}
  ...
  <div id="seo-sidenav" class="card">
      ...
      <div class="card-body p-3 pb-0">
          <div class="row">
              <div class="col-md-7">
                  <div class="form-group">
                      {{ Form::label('meta_title', __('Meta Title'), ['class' => 'col-form-label pt-0']) }}
  ...
  <div class="card" id="cache-sidenav">
      ...
      <form method="GET" action="{{ route('config.cache') }}" accept-charset="UTF-8">
              ...
              <div class="row">
                  <div class="col-12 form-group">
                      ...
                      <div class="input-group gap-2">
                          <input type="text" class="form-control rounded-1" value="{{ CacheSize() }}"
                              readonly>
          ...
          <div class="card-footer p-3 text-end">
              <input class="btn btn-print-invoice btn-primary" type="submit" value="{{ __('Cache Clear') }}">
          </div>
          {{ Form::close() }}
  </div>
  ...
  <div class="card" id="custom-js-sidenav">
      ...
      {{ Form::open(['url' => route('super.admin.custom.js.save'), 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
      <div class="card-body p-3 pb-0">
          <div class="row">
              <div class="col-12 form-group">
  ...
  <div class="card" id="custom-css-sidenav">
      ...
      {{ Form::open(['url' => route('super.admin.custom.css.save'), 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
      <div class="card-body p-3 pb-0">
          <div class="row">
              <div class="col-12 form-group">
                  <div class="input-group">
 ...
 <script>
    ...
    // FORCE FORM SUBMISSION - Fix for settings not saving
    document.addEventListener('DOMContentLoaded', function() {
        var settingForm = document.getElementById('setting-form');
        if (settingForm) {
            console.log('Settings form found, adding submit override');
            
            // Remove any existing submit event listeners by cloning the form
            var newForm = settingForm.cloneNode(true);
            settingForm.parentNode.replaceChild(newForm, settingForm);
            
            // Add new submit handler that actually submits
            newForm.addEventListener('submit', function(e) {
                console.log('Form submit triggered');
                // Let it submit normally - don't prevent default
                return true;
            });
            
            console.log('Form submit override installed');
        } else {
