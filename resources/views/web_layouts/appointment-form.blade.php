...
<div class="container">
    ...
    <div class="form-wizard">
        <div class="steps">
            <ul>
                ...
                @if (module_is_active('ZoomMeeting', $business->created_by) || module_is_active('GoogleMeet', $business->created_by))
                    <li class="stapes_status" id="onlineAppointmentStep" style="display: none;"></li>
                @endif
        ...
        {{ Form::open(['url' => '#', 'method' => 'post', 'id' => 'appointment-form', 'class' => 'appointment-form', 'enctype' => 'multipart/form-data']) }}
        @csrf
        <div class="myContainer">
            {{-- Services --}}
            {{-- Services --}}
            <div class="step-container" id="step-first">
                <div class="appointment-wrp Shoppint-Cart-btn">
                    <div class="appointment-form">
                        <h3 class="h6">{{ __('Please Select Services:') }}</h3>
                        <div class="row">
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label>{{ __('Choose a category') }} <span class="text-danger">*</span></label>
                                    <select class="form-control" id="categorySelect" name="category" required>
                                        <option value="" disabled selected>{{ __('Select category first') }}</option>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label>{{ __('Choose a services') }} <span class="text-danger">*</span></label>
                                    <select class="form-control" id="serviceSelect" name="service" disabled required>
                                        <option value="" disabled selected>{{ __('Select category first') }}</option>
                                    </select>
                                    <input type="hidden" name="service_id_zoom" id="service_id_zoom">
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="staffSelect" name="staff">
                                        <option value="" disabled selected>{{ __('Select staff') }}</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="step-btns">
                        ...
                        <div class="action-btn">
                            @stack('abuse_btn')
                            <button type="button" name="next" class="next sequential_button action-button btn">
                                {{ __('Next step') }}
                            </button>
                        </div>
                    </div>
                ...
                <div class="appointment-wrp Shoppint-Cart-btn">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="datepicker" type="text" id="datepicker" name="appointment_date"
                    ...
                    <div class="step-btns">
                        ...
                        <div class="action-btn">
                            ...
                            <button type="button" name="next" class="cart-save next action-button btn">
                                {{ __('Next') }}
                            </button>
                        </div>
                    </div>
                                ...
                                @foreach ($custom_fields as $custom_field)
                                    <div class="col-md-6 col-12 form-group">
                                        @if (
                                            ...
                                            <label for={{ $custom_field->label }}>{{ $custom_field->label }}</label>
                                        @endif
                                        ...
                                        @elseif($custom_field->type === 'number')
                                            <input type="number" class="form-control"
                                                name="values[number][{{ $custom_field->label }}]" placeholder="Value"
                                                value="{{ $custom_field->value }}">
                                        @endif
                                    </div>
                                @endforeach
                ...
                <div class="appointment-wrp">
                    ...
                    <div class="appointment-form payment-method-form">
                        <div class="section-title">
                            <h3 class="h5">{{ __('Payment Method :') }}</h3>
                ...
                <div class="appointment-wrp">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <span>
                                    <svg id="fi_13965236" enable-background="new 0 0 100 100" viewBox="0 0 100 100"
                    ...
                    <div class="step-btns">
                        @stack('iCal_exports')
                        <a href="{{ route('appointments.form', ['slug' => $slug, 'appointment' => '']) }}#appointment"
